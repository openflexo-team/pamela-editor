...
public class ClassDiagramEditorPalette extends PaletteModel {

	@SuppressWarnings("unused")
	private static final Logger logger = FlexoLogger.getLogger(ClassDiagramEditorPalette.class.getPackage().getName());
	...
	protected PaletteElement buildPaletteElement(final PaletteElementSpecification paletteElement) {
		PaletteElement returned = new PaletteElement() {
			...
			public boolean elementDragged(DrawingTreeNode<?, ?> target, DianaPoint dropLocation) {
				...
				ClassDiagramElement<?, ?> container = (ClassDiagramElement<?, ?>) target.getDrawable();
