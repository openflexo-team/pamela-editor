...
@ModelEntity
@ImplementationClass(ClassDiagramElementImpl.class)
public interface ClassDiagramElement<M extends ClassDiagramElement<M, G>, G extends GraphicalRepresentation> extends Cloneable, Observer,
