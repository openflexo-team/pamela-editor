...
import org.openflexo.pamela.editor.ui.diagram.DrawEdgeControl.DrawEdgeAction;

public class ClassDiagramEditorView extends JDrawingView<ClassDiagram> {
	public ClassDiagramEditorView(DianaDrawingEditor controller) {
		super(controller);
	}
