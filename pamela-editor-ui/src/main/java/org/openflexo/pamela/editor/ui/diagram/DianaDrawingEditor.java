...
import org.openflexo.pamela.editor.diagram.ClassDiagramElement;
import org.openflexo.pamela.editor.diagram.ClassDiagramFactory;
import org.openflexo.pamela.editor.diagram.Shape;

public class DianaDrawingEditor extends JDianaInteractiveEditor<ClassDiagram> {

	private static final Logger logger = Logger.getLogger(DianaDrawingEditor.class.getPackage().getName());

	private JPopupMenu contextualMenu;

	public DianaDrawingEditor(final ClassDiagramDrawing aDrawing, ClassDiagramFactory factory, SwingToolFactory toolFactory) {
		...
		DrawConnectorAction drawConnectorAction = new DrawConnectorAction() {
			...
			public void performedDrawNewConnector(ConnectorGraphicalRepresentation graphicalRepresentation, ShapeNode<?> startNode,
				...
				((ClassDiagramElement<?, ?>) fatherNode.getDrawable()).addToConnectors(newConnector);
	...
	public ClassDiagramDrawing getDrawing() {
		return (ClassDiagramDrawing) super.getDrawing();
	}

	@Override
	public ClassDiagramFactory getFactory() {
		return (ClassDiagramFactory) super.getFactory();
	}
	...
	@Override
	public ClassDiagramEditorView makeDrawingView() {
		return new ClassDiagramEditorView(this);
	}

	@Override
	public ClassDiagramEditorView getDrawingView() {
		return (ClassDiagramEditorView) super.getDrawingView();
	}
