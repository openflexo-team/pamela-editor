...
public abstract class ClassDiagramElementImpl<M extends ClassDiagramElement<M, G>, G extends GraphicalRepresentation> implements ClassDiagramElement<M, G> {
	...
	public ClassDiagramElementImpl(ClassDiagram classDiagram) {
	...
	*/
	...
	@Override
	public void setDiagram(ClassDiagram drawing) {
		classDiagram = drawing;
	}
	...
	@Override
	public ClassDiagramElement<M, G> clone() {
		return (ClassDiagramElement<M, G>) cloneObject();
