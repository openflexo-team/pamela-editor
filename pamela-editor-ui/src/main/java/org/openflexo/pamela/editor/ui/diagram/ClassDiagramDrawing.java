...
import org.openflexo.pamela.editor.diagram.Connector;
import org.openflexo.pamela.editor.diagram.ClassDiagram;
import org.openflexo.pamela.editor.diagram.ClassDiagramFactory;
import org.openflexo.pamela.editor.diagram.Shape;
import org.openflexo.pamela.exceptions.ModelDefinitionException;
import org.openflexo.pamela.factory.EditingContextImpl;

public class ClassDiagramDrawing extends DrawingImpl<ClassDiagram> {

	public ClassDiagramDrawing(ClassDiagram model, DianaModelFactory factory) {
	...
	public void init() {
		...
		final DrawingGRBinding<ClassDiagram> drawingBinding = bindDrawing(ClassDiagram.class, "drawing", new DrawingGRProvider<ClassDiagram>() {
			@Override
			public DrawingGraphicalRepresentation provideGR(ClassDiagram drawable, DianaModelFactory factory) {
		...
		// visitor plutot ?
		drawingBinding.addToWalkers(new GRStructureVisitor<ClassDiagram>() {

			@Override
			public void visit(ClassDiagram myDrawing) {
	...
	public static void main(String[] args) throws ModelDefinitionException {
		...
		ClassDiagramFactory factory = new ClassDiagramFactory(editingContext);
		ClassDiagram myDrawing = factory.makeNewDiagram();
		new ClassDiagramDrawing(myDrawing, factory);
	}
}
