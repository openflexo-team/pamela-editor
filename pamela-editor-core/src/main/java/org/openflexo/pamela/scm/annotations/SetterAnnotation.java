 ...
 */
public class SetterAnnotation extends PamelaAnnotation {

    public SetterAnnotation(JavaAnnotation annotationSource) {
     ...
     */
    public SetterAnnotation setValue(String value) {
